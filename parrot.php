...
body {
    background-image: url('images/background-parrot.jpeg') !important; /* Aapki desktop cats pic ka exact path */
...
.parrots-page-title {
    ...
    color: #98ec8c !important;                /* Rich premium dark color */
...
.back-btn {
    ...
    color: green; /* Custom deep rose pink branding color */
...
.back-btn:hover {
    background-color: green; /* Background brand color me fill ho jayega */
...
/* Form structure layout helper reset */
.cart-form {
  margin: 0;
  padding: 0;
}
...
<body>
  ...
  <div class="products-container">
    ...
    <!-- 8 Professional Parrot Type Cards Grid -->
    <div class="products-grid">
      
      <!-- Parrot 1 -->
      <div class="product-card">
        <div class="product-img-wrapper">
          <img src="images/green-ringneck.jpeg" alt="Green Ringneck">
        </div>
        <div class="product-info">
          <h4>Green Ringneck</h4>
          <p>Large, breathtakingly colorful, highly social and majestic bird.</p>
        </div>
        <div class="product-footer">
          <span class="product-price">Rs. 5000-8000 PKR</span>
          <form action="add-cart.php" method="POST" class="cart-form">
            <input type="hidden" name="item_name" value="Green Ringneck">
            <input type="hidden" name="item_price" value="6500"> <!-- Calculated balance placeholder -->
      ...
      <div class="product-card">
        <div class="product-img-wrapper">
          <img src="images/Raw-parrot.jpeg" alt="Raw Parrot">
        </div>
        <div class="product-info">
          <h4>Raw Parrot (Alexandrine)</h4>
          <p>World-class talker, exceptionally smart, and emotionally intelligent.</p>
        </div>
        <div class="product-footer">
          <span class="product-price">Rs. 25000-35,000 PKR</span>
          <form action="add-cart.php" method="POST" class="cart-form">
      ...
      <div class="product-card">
        <div class="product-img-wrapper">
          <img src="images/Love-birds.jpeg" alt="Love Birds">
        </div>
        <div class="product-info">
          <h4>Love Birds</h4>
          <p>Small, cheerful, budget-friendly and perfect for beginners.</p>
        </div>
        <div class="product-footer">
      ...
      <div class="product-card">
        <div class="product-img-wrapper">
          <img src="images/Cockatiel.jpeg" alt="Cockatiel">
        </div>
        <div class="product-info">
          <h4>Cockatiel</h4>
          <p>Gentle whistle-master, famous for distinct orange cheek patches.</p>
        </div>
        <div class="product-footer">
          <span class="product-price">Rs. 3500-7000 PKR</span>
          <form action="add-cart.php" method="POST" class="cart-form">
      ...
      <div class="product-card">
        <div class="product-img-wrapper">
          <img src="images/budgerigar.jpeg" alt="Budgerigar">
        </div>
        <div class="product-info">
          <h4>Budgerigar</h4>
          <p>Small, vibrant, intensely loyal, and loves living in pairs.</p>
        </div>
        <div class="product-footer">
          <span class="product-price">Rs. 1000-2500 PKR</span>
          <form action="add-cart.php" method="POST" class="cart-form">
      ...
      <div class="product-card">
        <div class="product-img-wrapper">
          <img src="images/African-grey.jpeg" alt="African Grey Parrot">
        </div>
        <div class="product-info">
          <h4>African Grey Parrot</h4>
          <p>Extremely talkative, bold personality, and beautiful green feathers.</p>
        </div>
        <div class="product-footer">
          <span class="product-price">Rs. 80,000-120,000 PKR</span>
          <form action="add-cart.php" method="POST" class="cart-form">
      ...
      <div class="product-card">
        <div class="product-img-wrapper">
          <img src="images/plum-headed.jpeg" alt="Plum-headed Parakeet">
        </div>
        <div class="product-info">
          <h4>Plum-headed Parakeet</h4>
          <p>Stunning dimorphic colors (bright green males, deep red females).</p>
        </div>
        <div class="product-footer">
          <span class="product-price">Rs. 8000-12000 PKR</span>
          <form action="add-cart.php" method="POST" class="cart-form">
      ...
      <div class="product-card">
        ...
        <div class="product-info">
          <h4>Sun Conure</h4>
          <p>Elegant long tail, clear speaking ability and iconic neck ring.</p>
        </div>
        <div class="product-footer">
          <span class="product-price">Rs. 45,000-60,000 PKR</span>
          <form action="add-cart.php" method="POST" class="cart-form">
            <input type="hidden" name="item_name" value="Sun Conure">
            <input type="hidden" name="item_price" value="52500">
            <button type="submit" name="add_to_cart" class="add-to-cart-btn">BUY NOW</button>
          </form>
        </div>
      </div>
